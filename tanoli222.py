...
Author : TANOLI [ NAAM TU SUNA HUGA ]
...
88""Yb    db    88b 88    db        8b    d8 8888P 

88__dP   dPYb   88Yb88   dPYb       88b  d88   dP  

88"Yb   dP__Yb  88 Y88  dP__Yb      88YbdP88  dP   

88  Yb dP""""Yb 88  Y8 dP""""Yb     88 YY 88 d8888 
...
\033[0;97m
 ...
 ( N | A | M ) ( T | U ) ( S | U | N | A ) ( H | U | G | A )

  \_/ \_/ \_/   \_/ \_/   \_/ \_/ \_/ \_/   \_/ \_/ \_/ \_/ 

\033[0;93m──────────────────────────────────────────────────────

\033[0;95m{\033[0;96m×\033[0;95m} \033[0;93mAuthor   \033[0;91m: \033[0;96mRana MZ

\033[0;95m{\033[0;96m×\033[0;95m} \033[0;93mHAHA   \033[0;91m: \033[0;96m[ NAM TU SUNA HUGA ]

\033[0;95m{\033[0;96m×\033[0;95m} \033[0;93mSocial \033[0;91m: \033[0;96mRana MZ""")
...
def menu():
	...
	print ('\033[0;95m1.\033[0;97m Crack ID From Friends / Public ');time.sleep(0.07)

	print ('\033[0;95m2.\033[0;97m Crack ID From Like Friends / Public');time.sleep(0.07)

	print ('\033[0;95m3.\033[0;97m Crack ID of Followers');time.sleep(0.07)

	print ('\033[0;95m4.\033[0;97m Find ID Using Username');time.sleep(0.07)

	print ('\033[0;95m5.\033[0;97m View Crack Results');time.sleep(0.07)

	print ('\033[0;95m6.\033[0;97m Update Script');time.sleep(0.07)
	...
	def main(arg):
		...
		try:
			...
			if 'mbasic_logout_button' in xo or 'save-device' in xo:
				...
				print '\033[0;92mMZ\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+pw
				...
				if 'checkpoint' in xo:
					...
					if 'mbasic_logout_button' in xo or 'save-device' in xo:
						...
						print '\033[0;92mMZ\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+pw2
						...
						if 'checkpoint' in xo:
							...
							if 'mbasic_logout_button' in xo or 'save-device' in xo:
								...
								print '\033[0;92mMZ\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+pw3
								...
								if 'checkpoint' in xo:
									...
									if 'mbasic_logout_button' in xo or 'save-device' in xo:
										...
										print '\033[0;92mMZ\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+pw4
	...
	def main(arg):
		...
		try:
			...
			if 'mbasic_logout_button' in xo or 'save-device' in xo:
				...
				print '\033[0;92mMZ\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+pz
				...
				if 'checkpoint' in xo:
					...
					if 'mbasic_logout_button' in xo or 'save-device' in xo:
						...
						print '\033[0;92mMZ\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+pz2
						...
						if 'checkpoint' in xo:
							...
							if 'mbasic_logout_button' in xo or 'save-device' in xo:
								...
								print '\033[0;92mMZ\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+pz3
								...
								if 'checkpoint' in xo:
									...
									if 'mbasic_logout_button' in xo or 'save-device' in xo:
										...
										print '\033[0;92mMZ\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+pz4
	...
	def main(art):
		...
		try:
			...
			if 'mbasic_logout_button' in xs or 'save-device' in xs:
				...
				print '\033[0;92mMZ\033[0;97m '+ef+' \033[0;92m∆ \033[0;97m'+pb
				...
				if 'checkpoint' in xs:
					...
					if 'mbasic_logout_button' in xs or 'save-device' in xs:
						...
						print '\033[0;92mMZ\033[0;97m '+ef+' \033[0;92m∆ \033[0;97m'+pb2
						...
						if 'checkpoint' in xs:
							...
							if 'mbasic_logout_button' in xs or 'save-device' in xs:
								...
								print '\033[0;92mMZ\033[0;97m '+ef+' \033[0;92m∆ \033[0;97m'+pb3
								...
								if 'checkpoint' in xs:
									...
									if 'mbasic_logout_button' in xs or 'save-device' in xs:
										...
										print '\033[0;92mMZ\033[0;97m '+ef+' \033[0;92m∆ \033[0;97m'+pb4
										...
										if 'checkpoint' in xs:
											...
											if 'mbasic_logout_button' in xs or 'save-device' in xs:
												...
												print '\033[0;92mMZ\033[0;97m '+ef+' \033[0;92m∆ \033[0;97m'+pb5
	...
	def main(arg):
		...
		try:
			...
			if 'mbasic_logout_button' in xo or 'save-device' in xo:
				...
				print '\033[0;92mMZ\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+px
				...
				if 'checkpoint' in xo:
					...
					if 'mbasic_logout_button' in xo or 'save-device' in xo:
						...
						print '\033[0;92mMZ\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+px2
						...
						if 'checkpoint' in xo:
							...
							if 'mbasic_logout_button' in xo or 'save-device' in xo:
								...
								print '\033[0;92mMZ\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+px3
								...
								if 'checkpoint' in xo:
									...
									if 'mbasic_logout_button' in xo or 'save-device' in xo:
										...
										print '\033[0;92mMZ\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+px4
	...
	def main(arg):
		...
		try:
			...
			if 'mbasic_logout_button' in xo or 'save-device' in xo:
				...
				print '\033[0;92mMZ\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+pc
				...
				if 'checkpoint' in xo:
					...
					if 'mbasic_logout_button' in xo or 'save-device' in xo:
						...
						print '\033[0;92mMZ\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+pc2
						...
						if 'checkpoint' in xo:
							...
							if 'mbasic_logout_button' in xo or 'save-device' in xo:
								...
								print '\033[0;92mMZ\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+pc3
								...
								if 'checkpoint' in xo:
									...
									if 'mbasic_logout_button' in xo or 'save-device' in xo:
										...
										print '\033[0;92mMZ\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+pc4
	...
	def main(arg):
		...
		try:
			...
			if 'mbasic_logout_button' in xo or 'save-device' in xo:
				...
				print '\033[0;92mMZ\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+pr
				...
				if 'checkpoint' in xo:
					...
					if 'mbasic_logout_button' in xo or 'save-device' in xo:
						...
						print '\033[0;92mMZ\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+pr2
						...
						if 'checkpoint' in xo:
							...
							if 'mbasic_logout_button' in xo or 'save-device' in xo:
								...
								print '\033[0;92mMZ\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+pr3
								...
								if 'checkpoint' in xo:
									...
									if 'mbasic_logout_button' in xo or 'save-device' in xo:
										...
										print '\033[0;92mMZ\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+pr4
